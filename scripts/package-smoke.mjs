...
try {
  ...
  if (!run(process.execPath, [bin, '--version']).includes('0.4.0')) throw new Error('Version command failed');
  ...
  writeFileSync(join(rust, 'package.json'), '{"devDependencies":{"@kelbie/hunch":"0.4.0"}}');
