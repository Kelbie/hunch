...
each question is given, is explained in [configuration](docs/configuration.md).
...
[Run your own App](docs/cli-setup.md) · [Deploy](docs/deploy.md) · [Sample report](docs/sample-report.md)
