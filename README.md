...
The documentation is an [Agent Skill](skills/hunch/SKILL.md). Install it, and your coding agent knows
...
![Reviewing a branch with two rules passed on the command line](docs/images/check-rules.png)
...
[install](skills/hunch/references/install.md).
...
[CLI reference](skills/hunch/references/cli.md) is generated from the CLI, and
[examples](skills/hunch/examples) are captured from real runs.
...
[rules](skills/hunch/references/rules.md), and every setting in [config](skills/hunch/references/config.md).
...
[Skill](skills/hunch/SKILL.md) · [Architecture](docs/architecture.md) ·
[Run your own App](skills/hunch/references/operator.md) · [Deploy](docs/deploy.md) · [Sample report](docs/sample-report.md)
